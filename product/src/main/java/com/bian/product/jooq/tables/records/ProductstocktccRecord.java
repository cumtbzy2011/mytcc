...
public class ProductstocktccRecord extends UpdatableRecordImpl<ProductstocktccRecord> implements Record8<ULong, Timestamp, Timestamp, Timestamp, Timestamp, UInteger, Boolean, ULong> {

    private static final long serialVersionUID = 923126161;
     ...
     */
    @Override
    public Row8<ULong, Timestamp, Timestamp, Timestamp, Timestamp, UInteger, Boolean, ULong> fieldsRow() {
     ...
     */
    @Override
    public Row8<ULong, Timestamp, Timestamp, Timestamp, Timestamp, UInteger, Boolean, ULong> valuesRow() {
     ...
     */
    @Override
    public ProductstocktccRecord value7(Boolean value) {
        setStatus(value);
        return this;
    }
     ...
     */
    @Override
    public ProductstocktccRecord values(ULong value1, Timestamp value2, Timestamp value3, Timestamp value4, Timestamp value5, UInteger value6, Boolean value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProductstocktccRecord(ULong id, Timestamp createTime, Timestamp updateTime, Timestamp deleteTime, Timestamp expireTime, UInteger stock, Boolean status, ULong tProductId) {
        super(Productstocktcc.PRODUCTSTOCKTCC);
